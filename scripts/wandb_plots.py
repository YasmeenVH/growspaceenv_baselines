...
if __name__ == "__main__":
    ...
    if analysis=='hierarchy':
        ...
        hierarchy_easy = ["growspace/hierarchy/jueepcl0", "growspace/hierarchy/3c8fbek9",
                          "growspace/hierarchy/15h341e6"]
        hierarchy_hard = ["growspace/hierarchy/1p9dxq57", "growspace/hierarchy/1rcmk4bn",
                          "growspace/growspaceenv_baselines/3i9p841q"]
