...
if __name__ == "__main__":
    ...
    if analysis=='hierarchy':
        ...
        r_easy, r_easy_smooth = extract_(hierarchy_easy, 5)
        r_hard, r_hard_smooth = extract_(hierarchy_hard, 5)
    ...
    if analysis=='control':
        ...
        r_easy,r_easy_smooth = extract_(control_easy, 5)
        r_hard, r_hard_smooth = extract_(control_hard, 5)
        # for i in range(len(r_easy_smooth)):
        #     print(len(r_easy_smooth[i]))
        #     print(len(r_hard_smooth[i]))
    ...
    if analysis=='fairness':
        ...
        r_easy,r_easy_smooth = extract_(fairness_easy, 5)
        r_middle, r_middle_smooth = extract_(fairness_middle, 5)
